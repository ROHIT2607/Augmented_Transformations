...
const App = () => {
  ...
  return (
    <Container
      fluid
      className="mt-2 py-5 text-white"
      style={{
        background: "black",
      }}
    >
      <div style={{
        ...
        <p style={{ fontSize: "18px", color: "#D3D3D3" }}>
          At Augmented Transformations, we offer innovative solutions for
          data-driven businesses across a wide range of industry verticals,
          including Government, Manufacturing, IT & ITES, BFSI, Hospitality, and
          E-Commerce. Our expertise in these new technologies enables us to
          assist our clients in their digital transformation journey.
        </p>
      </div>
      <div
